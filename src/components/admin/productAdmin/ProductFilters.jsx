		...
		<div className="mb-6 flex flex-col gap-4 rounded-lg bg-white p-4 shadow-sm xl:flex-row xl:items-center xl:justify-between">
				...
				<div className="w-full shrink-0 lg:w-64 xl:w-56">
					<div className="relative">
						<input
							...
							className="w-full rounded-lg border border-gray-300 py-2 pl-10 pr-4 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-orange-500"
						/>
			...
			<div className="flex w-full flex-wrap gap-3 lg:w-auto lg:flex-nowrap lg:justify-end">
				...
				<button
					...
					className="flex items-center whitespace-nowrap rounded-lg bg-orange-500 px-4 py-2 text-white hover:bg-orange-600"
				>
