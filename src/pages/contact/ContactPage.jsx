...
const ContactPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      alert("Gửi thông tin thành công. Shop sẽ liên hệ lại sớm nhất!");
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-10">
              ...
              <div className=" h-[200px] flex justify-center items-center rounded-2xl bg-gray-100">
                <div className="block-time text-center flex justify-center items-center flex-col gap-2">
                  ...
                  <span className="text-gray-500">bangnga@gmail.com</span>
                </div>
              </div>
              ...
              <div className=" h-[200px] flex justify-center items-center rounded-2xl bg-gray-100">
                <div className="block-time text-center flex justify-center items-center flex-col gap-2">
                  ...
                  <span className="text-gray-500">+84 362648200</span>
                </div>
              </div>
            </div>
